...
public class ListController : ControllerBase
{
    ...
    string Trim(string before, string item, string after)
    {
    ...
    void ParseLinks(string url, Dictionary<string, string> result)
    {
    ...
    {
        var tables = this.Request.Query["urls"].ToString().Split(';').AsParallel().AsOrdered().Select(_ => ParseTable(_)).ToList();
    ...
    List<List<string>> ParseTable(string param)
    {
